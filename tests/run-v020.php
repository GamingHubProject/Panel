...
$check(($plugin['version'] ?? null) === '0.2.0', 'plugin version is 0.2.0');
$check(($manifest['version'] ?? null) === '0.2.0', 'extension manifest version is 0.2.0');
$check(($plugin['dependencies']['gaming-hub-core'] ?? null) === '^0.6.0', 'Gaming Hub Core compatibility remains ^0.6.0');
