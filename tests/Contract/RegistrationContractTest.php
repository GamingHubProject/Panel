...
final class RegistrationContractTest extends TestCase
{
    ...
    public function testCoreCompatibilityIsBoundedThroughZeroSevenAndUsesInterfaceProbe(): void
    {
        $source = file_get_contents(dirname(__DIR__, 2).'/src/Support/CoreCompatibility.php');

        self::assertStringContainsString("VERSION_CONSTRAINT = '>=0.6.0 <0.8.0'", $source);
