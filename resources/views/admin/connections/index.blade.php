...
<div class="card">
    ...
    <div class="card-body">
        <div class="alert alert-info">
            Panel Connections can be created and tested here, but no Provider Type currently accepts a mapping to them — Pelican/Pterodactyl registration is temporarily disabled pending Connector installation. See <code>docs/CONNECTOR_MIGRATION_AUDIT.md</code>.
        </div>
